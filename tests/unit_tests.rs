...
fn test_should_process_file_empty_path() {
    let processor = DirectoryProcessor::new(vec![], vec![], false, String::new());
    let path = Path::new("");
...
fn test_should_process_file_included_extension() {
    let processor = DirectoryProcessor::new(vec!["rs".to_string()], vec![], false, String::new());
...
fn test_should_process_file_excluded_globed_file() {
    let processor = DirectoryProcessor::new(vec![], vec!["*.py".to_string()], false, String::new());
